...
/// <summary>
/// MGSV Type2/Mini-GANI conservative AnimationClip builder.
/// Unity 2018.3 compatible editor tool.
///
/// This intentionally maps ONLY the high-confidence direct tracks:
///   U01 -> SKL_000_WAIST rotation (+ optional experimental translation)
...
///
/// Root-diff and limb/IK units U00/U06-U15 are NOT applied yet.
/// Source FMDL/GANI/TRK files are never modified.
/// </summary>
public class GANIType2BodyAlpha : EditorWindow
{
    ...
    [MenuItem("FMDL Studio/GANI Tools/Type2 Body Alpha Clip Builder")]
    public static void ShowWindow()
    {
        GANIType2BodyAlpha window =
            GetWindow<GANIType2BodyAlpha>("GANI Body Alpha");
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label(
            "MGSV Type2 / Mini-GANI - Body Alpha Clip Builder",
            EditorStyles.boldLabel
        );

        EditorGUILayout.HelpBox(
            "Conservative test builder. It creates a NEW Unity .anim asset and never modifies the source GANI/TRK/FMDL. " +
            "It currently applies torso/head + fingers only. Limb IK and root-diff are deliberately ignored.",
            MessageType.Info
        );
        ...
        if (GUILayout.Button(
            "Build Partial AnimationClip (.anim)",
            GUILayout.Height(42)))
        {
            BuildClip();
        }
        ...
        GUILayout.Label("Current conservative mapping", EditorStyles.boldLabel);
        ...
        GUILayout.Label("U16 segments  -> 16 left finger bones (hierarchy order)");
        GUILayout.Label("U17 segments  -> 16 right finger bones (hierarchy order)");
        GUILayout.Space(6);
        GUILayout.Label("Ignored for now:", EditorStyles.boldLabel);
        GUILayout.Label("U00 root QUAT_DIFF / VECTOR_DIFF");
        GUILayout.Label("U06-U15 limb / IK-related units");
    ...
    private void BuildClip()
    {
        ...
        try
        {
            ...
            report.AppendLine("MGSV TYPE2 BODY ALPHA CLIP BUILD");
            report.AppendLine("============================================================");
            ...
            EditorUtility.DisplayDialog(
                ...
                assetPath +
                "\n\n" +
                "Mapped: WAIST/SPINE/CHEST/NECK/HEAD + both hands' 16 finger tracks.\n" +
                "Limb IK/root motion remain intentionally untouched.",
                "OK"
            );
        }
        catch (Exception ex)
        {
            UnityEngine.Debug.LogError(
                "GANI Body Alpha build failed:\n" +
                ex
            );

            EditorUtility.DisplayDialog(
                "GANI Body Alpha Error",
                ex.Message,
                "OK"
            );
        }
